...
This is an example code for the paper "Discrete Optimization for Shape Matching" by [Jing Ren](https://ren-jing.com/), [Simone Melzi](https://sites.google.com/site/melzismn/), [Peter Wonka](http://peterwonka.net/), and [Maks Ovsjanikov](http://www.lix.polytechnique.fr/~maks/).
